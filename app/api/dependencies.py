...
# OAuth2 setup declaring where the token format is generated.
...
def get_current_user(
    ...
    """
    Dependency that decodes the JWT and fetches the user.
    """
...
def get_current_active_user(
    ...
    """
    Dependency ensuring the user is both authorized AND active.
    """
